...
import 'package:football_fever/view/match/page/match_details_screen.dart';
...
class LiveMatchTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        if (matchModel.scores == null || (matchModel.scores ?? []).isEmpty) {
        } else {
          Get.to(
                              ...
                              children: [
                                Icon(
                                  ...
                                  color: Get.theme.disabledColor,
                                    ...
                                    .shake(
                                        hz: 2, duration: 500.ms, rotation: .4),
                                3.horizontalSpace,
                                Text(
                                  maxLines: 1,
