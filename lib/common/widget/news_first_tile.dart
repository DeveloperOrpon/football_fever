...
class NewsFirstTile extends StatelessWidget {
  final NewsModel newsModel;

  const NewsFirstTile({super.key, required this.newsModel});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        height: Get.width > 600 ? 250.h : 230.h,
        width: Get.width,
        ...
        child: Column(
          children: [
            Container(
              height: Get.width > 600 ? 200.h : 180.h,
              width: Get.width,
              color: Colors.black,
              child: Hero(
                ...
                child: ClipRRect(
                  ...
                  child: NetImageView(
                    ...
                    height: Get.width > 600 ? 180.h : 160.h,
                    fit: BoxFit.fitWidth,
                  ),
                ),
              ),
